...
public final class ProjectGraphSerialization {
    ...
    public static final class Snapshot {
        ...
        static Snapshot from(ProjectGraph g) {
            ...
            for (ProjectGraph.GraphNode n : g.nodes.values()) {
                nodes.add(NodeSnapshot.from(n));
            }
            List<EdgeSnapshot> edges = new ArrayList<>();
            for (List<ProjectGraph.GraphEdge> list : g.edgesFrom.values()) {
        ...
        ProjectGraph toGraph() {
            ...
            List<ProjectGraph.GraphNode> nodeList = new ArrayList<>();
            for (NodeSnapshot n : nList) {
                nodeList.add(n.toGraphNode());
            }
            List<ProjectGraph.GraphEdge> edgeList = new ArrayList<>();
    ...
    public static final class NodeSnapshot {
        ...
        static NodeSnapshot from(ProjectGraph.GraphNode n) {
        ...
        ProjectGraph.GraphNode toGraphNode() {
            return new ProjectGraph.GraphNode(
                    id,
    ...
    public static final class EdgeSnapshot {
        ...
        static EdgeSnapshot from(ProjectGraph.GraphEdge e) {
        ...
        ProjectGraph.GraphEdge toGraphEdge() {
            return new ProjectGraph.GraphEdge(
                    caller,
