 ...
 */
public class MarkdownLambdaNode extends MarkdownNode {

    private MarkdownNode declaredByExecutable;
    ...
    public MarkdownLambdaNode(GraphNode node) { super(node); }

    public MarkdownNode getDeclaredByExecutable() { return declaredByExecutable; }
    ...
    public void setDeclaredByExecutable(MarkdownNode v)    { this.declaredByExecutable = v; }
