...
Трудно переоценить важность решения автоматизировать тестирование АС ДКО. Из автоматизации АС ДКО выросла половина отдела автоматизации.
1) В РЦТиКК большинство действующих подходов и правил взаимодействия между командами аналитики и автоматизации появились в процессе автоматизации ДКО. На протяжении 5 лет мы ставим наше взаимодествие в пример другим командам. И, как показывает пример других команд, наш совместный успех построен на взаимопонимании и стремлении к общей цели. Сколько раз мы слышали от других команд, что у них связаны руки технологическими картами и они не могут адаптировать тестирование под нужды автоматизации! А в результате автотесты делаются "для галочки". Некоторые команды приходится убеждать, что им нужна автоматизация. С командами АС ДКО ситуация обратная - они сами приходят и говорят "дайте автоматизацию!". Всегда приятно работать в коллективе, в котором людям не все равно, каким будет результат.
2) История автоматизации берет начало примерно 8 лет назад. За основу взят IBM RFT, на его основе построен фреймворк с проксируемыми элементами управления и PageObject. Изначально RFT предоставляет полноценную среду тестирования. Очень мощный инструмент для систем, написанных на java. Для наших целей пришлось выбрать из него только механизмы поиска элементов. Своего рода обратный инжиниринг. Сейчас компетенции автоматизаторов заметно подросли, но фреймворк АС ДКО по прежнему выгляд интересным. Важная деталь: фреймворк усточив к изменениям системы и последний серьезный рефакторинг был в 2020 году. Даже не знаю, изменили бы мы что-то если бы начали сначала или нет. Скорее, нет.
3) сложная логика сравнения файлов
